...
public class PakuriProgram {
    public static void main(String[] args) {
        ...
        do {
            while (!currentChoice && !gameTerminate) {
                ...
                try {
                    ...
                    switch (userChoice) {
                        ...
                        case 1:
//                            String[] kuriArray = pakudexSpecies.getSpeciesArray();
                        ...
                        case 2:
                            ...
                            String speciesDisplayName = userInput.next();
                            ...
                            for (int i = 0; i < displayKuri.length; i++) {
                                if (displayKuri[i] != null && displayKuri[i].getSpecies().equals(speciesDisplayName)) {
                                    boolControl = true;

                                    int[] speciesStatsResult = pakudexSpecies.getStats(speciesDisplayName);
                                    System.out.println();
                                    System.out.println("Species: " + speciesDisplayName + "\n" +
                                            "Attack: " + speciesStatsResult[0] + "\n" +
                                            "Defense: " + speciesStatsResult[1] + "\n" +
                                            "Speed: " + speciesStatsResult[2] + "\n");
                                }
                            }
                        ...
                        case 4:
                            ...
                            try {
                                ...
                                for (Pakuri kuri : kuriSpeciesArray) {
                                    ...
                                    if (kuri.getSpecies().equals(evolveKuriName)) {
                                        ...
                                        break;
                                        // When speciesIndex equal to the last spot in the array,
                                        // that spot in the array in not empty
                                    } else if (speciesIndex == kuriSpeciesArray.length - 1) {
                                        System.out.println("Error: No such Pakuri!\n");
                                        break;
                                    }
                                }
                            ...
                            break;
                        case 5:
                            // Since species array will hold small number of species, selection
                            // sorting is applied on Pakuri elements, Pakuri elements are sorted in
                            // alphabetical order
